...
2. **Run the graph script**
   ...
   ```bash
   python "Start Your Own/Generate_Graph.py" --start-date 2023-01-01 --end-date 2023-12-31
   ```
3. **View the chart**
   - A window opens showing your portfolio value vs. S&P 500 using your actual starting equity.
